...
-- Allow all operations for everyone since this is a public app
CREATE POLICY "Allow all operations for everyone" ON media_files
  FOR ALL USING (true);
...
-- Create policy for public upload to storage
CREATE POLICY "Allow public upload" ON storage.objects
  FOR INSERT WITH CHECK (bucket_id = 'media');

-- Create policy for public delete from storage
