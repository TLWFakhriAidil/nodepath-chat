-- =====================================================
-- MANUAL SQL SCRIPT TO DROP UNUSED COLUMNS
-- Run this directly in your MySQL database
-- =====================================================

-- Step 1: Backup your table first (IMPORTANT!)
-- CREATE TABLE ai_whatsapp_nodepath_backup AS SELECT * FROM ai_whatsapp_nodepath;
...
-- Step 4: Add any missing new columns if they don't exist
ALTER TABLE ai_whatsapp_nodepath 
