// WAHA SUPPORT PATCH FOR device_settings_handlers.go
...
// ALSO UPDATE the sendTextMessage function around line 2209:
// In the switch statement, add:
	case "waha":
		h.sendWahaTextMessage(to, message, deviceSettings)

// ALSO UPDATE the sendImageMessage function around line 2231:
// In the switch statement, add:
	case "waha":
		h.sendWahaImageMessage(to, imageURL, deviceSettings)