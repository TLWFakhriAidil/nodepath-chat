...
func main() {
	...
	// Drop the global_instance column
	fmt.Println("Dropping global_instance column...")
	_, err = db.Exec("ALTER TABLE chatbot_flows_nodepath DROP COLUMN global_instance")
	if err != nil {
	...
	// Check table structure after drop
